...
const BUCKET_NAME = process.env.DATA_LAKE_BUCKET_RAW;//'musa5090s25-team6-raw_data'
const blobname = 'opa_properties/opa_properties.csv';
...
console.log(`Uploaded ${filename} to ${BUCKET_NAME}`); import fetch from 'node-fetch';
