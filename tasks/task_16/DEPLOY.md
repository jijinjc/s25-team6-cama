_run_property_tile_creation_sql_:
...
```shell
gcloud functions deploy run_property_tile_creation_sql ^
--gen2 ^
--region=us-east4 ^
--runtime=python312 ^
--source=. ^
--entry-point=run_property_tile_creation_sql ^
...
```shell
gcloud functions call run_property_tile_creation_sql ^
--region=us-east4
```
